...
void Vtop___024root___settle__TOP__1(Vtop___024root* vlSelf) {
    ...
    // Body
    vlSelf->top__DOT__ContrGen__DOT__isRegWr__DOT__pair_list[0U] = 5U;
    vlSelf->top__DOT__ContrGen__DOT__isRegWr__DOT__pair_list[1U] = 3U;
    vlSelf->top__DOT__ContrGen__DOT__deExtop__DOT__pair_list[0U] = 0x199U;
    vlSelf->top__DOT__ContrGen__DOT__deExtop__DOT__pair_list[1U] = 0x1aU;
    vlSelf->top__DOT__ContrGen__DOT__deExtop__DOT__pair_list[2U] = 0x9aU;
    ...
    vlSelf->top__DOT__Imm = ((IData)(vlSelf->top__DOT__ImmGen__DOT__isRegWr__DOT__hit)
                              ? vlSelf->top__DOT__ImmGen__DOT__isRegWr__DOT__lut_out
                              : 0ULL);
    VL_EXTEND_WQ(68,64, __Vtemp49, (((0x13U == (0x3ffU 
                                                & ((0x1fc00U 
                                                    & (vlSelf->Inst 
                                                       >> 0xfU)) 
                                                   | ((0x380U 
...
void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->top__DOT__PC__DOT____Vcellinp__NEXT_PC__din = VL_RAND_RESET_Q(64);
