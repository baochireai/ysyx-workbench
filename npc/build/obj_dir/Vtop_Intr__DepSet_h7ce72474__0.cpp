...
VL_INLINE_OPT void Vtop_Intr___ico_sequent__TOP__top__WB__IntrUnit__0(Vtop_Intr* vlSelf) {
    ...
    __PVT__scrDataSrc__DOT__lut_out = ((- (QData)((IData)(
                                       ...
                                       [0U]);
    __PVT__scrDataSrc__DOT__hit = ((7U & (vlSymsp->TOP__top.LSU_to_WB_Regs__DOT____Vcellout__exu_to_lus_pipeline_regs__dout[0U] 
                                          >> 0xcU)) 
                                   == vlSelf->__PVT__scrDataSrc__DOT__key_list
                                   [0U]);
    ...
    __PVT__scrDataSrc__DOT__hit = ((IData)(__PVT__scrDataSrc__DOT__hit) 
                                   | ((7U & (vlSymsp->TOP__top.LSU_to_WB_Regs__DOT____Vcellout__exu_to_lus_pipeline_regs__dout[0U] 
                                             >> 0xcU)) 
                                      == vlSelf->__PVT__scrDataSrc__DOT__key_list
                                      [1U]));
    __PVT__scrDataSrc__DOT__lut_out = (__PVT__scrDataSrc__DOT__lut_out 
