...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declQuad(c+271,"dpc", false,-1, 63,0);
    ...
    tracep->declQuad(c+624,"NextPCp", false,-1, 63,0);
    tracep->pushNamePrefix("dePCsrc ");
    tracep->declBus(c+827,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+822,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+816,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+817,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+626,"out", false,-1, 1,0);
    tracep->declBus(c+244,"key", false,-1, 2,0);
    tracep->declBus(c+848,"default_out", false,-1, 1,0);
    tracep->declQuad(c+627,"lut", false,-1, 34,0);
    tracep->declBus(c+849,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 7; ++i) {
        tracep->declBus(c+629+i*1,"pair_list", true,(i+0), 4,0);
    }
    for (int i = 0; i < 7; ++i) {
        tracep->declBus(c+105+i*1,"key_list", true,(i+0), 2,0);
    }
    for (int i = 0; i < 7; ++i) {
        tracep->declBus(c+636+i*1,"data_list", true,(i+0), 1,0);
    }
    tracep->declBus(c+643,"lut_out", false,-1, 1,0);
    ...
    tracep->declBus(c+646,"Inst", false,-1, 31,7);
    tracep->declBus(c+234,"Extop", false,-1, 2,0);
    tracep->declQuad(c+238,"Imm", false,-1, 63,0);
    tracep->pushNamePrefix("isRegWr ");
    ...
    tracep->declBus(c+234,"key", false,-1, 2,0);
    tracep->declQuad(c+818,"default_out", false,-1, 63,0);
    tracep->declArray(c+647,"lut", false,-1, 334,0);
    tracep->declBus(c+852,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 5; ++i) {
        tracep->declArray(c+658+i*3,"pair_list", true,(i+0), 66,0);
    }
    for (int i = 0; i < 5; ++i) {
        tracep->declBus(c+112+i*1,"key_list", true,(i+0), 2,0);
    }
    for (int i = 0; i < 5; ++i) {
        tracep->declQuad(c+673+i*2,"data_list", true,(i+0), 63,0);
    }
    tracep->declQuad(c+683,"lut_out", false,-1, 63,0);
    tracep->declBit(c+685,"hit", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullQData(oldp+242,(((0ULL == vlSymsp->TOP__top.__PVT__GenNextPC__DOT__NextPCp)
    ...
    bufp->fullQData(oldp+271,(vlSymsp->TOP__top.__PVT__dpc),64);
    ...
    __Vtemp_h2e3a2547__0[8U] = (0x80U | ((IData)((VL_DIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                  >> 0x20U)) 
                                         >> 0x1aU));
    bufp->fullWData(oldp+487,(__Vtemp_h2e3a2547__0),264);
    ...
    __Vtemp_h875f5da5__0[8U] = (0x80U | ((IData)((VL_MODDIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                  >> 0x20U)) 
                                         >> 0x1aU));
    bufp->fullWData(oldp+519,(__Vtemp_h875f5da5__0),264);
    ...
    bufp->fullQData(oldp+624,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__NextPCp),64);
    bufp->fullCData(oldp+626,(vlSymsp->TOP__top.GenNextPC__DOT____Vcellout__dePCsrc__out),2);
    bufp->fullQData(oldp+627,((QData)((IData)((0x898537eU 
                                               | ((((0U 
                                                     != vlSymsp->TOP__top.__PVT__ALU__DOT__adder)
                                                     ? 1U
                                                     : 3U) 
                                                  ...
                                                  | ((((0U 
                                                     ...
                                                     | ((((IData)(vlSymsp->TOP__top.__PVT__Less)
                                                        ...
                                                        | (((IData)(vlSymsp->TOP__top.__PVT__Less)
                                                             ...
                                                             : 3U) 
                                                           << 0xaU)))))))),35);
    bufp->fullCData(oldp+629,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[0]),5);
    bufp->fullCData(oldp+630,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[1]),5);
    bufp->fullCData(oldp+631,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[2]),5);
    bufp->fullCData(oldp+632,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[3]),5);
    bufp->fullCData(oldp+633,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[4]),5);
    bufp->fullCData(oldp+634,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[5]),5);
    bufp->fullCData(oldp+635,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__pair_list[6]),5);
    bufp->fullCData(oldp+636,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[0]),2);
    bufp->fullCData(oldp+637,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[1]),2);
    bufp->fullCData(oldp+638,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[2]),2);
    bufp->fullCData(oldp+639,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[3]),2);
    bufp->fullCData(oldp+640,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[4]),2);
    bufp->fullCData(oldp+641,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[5]),2);
    bufp->fullCData(oldp+642,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__data_list[6]),2);
    bufp->fullCData(oldp+643,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__lut_out),2);
    bufp->fullBit(oldp+644,(vlSymsp->TOP__top.__PVT__GenNextPC__DOT__dePCsrc__DOT__hit));
    bufp->fullIData(oldp+645,((IData)(vlSymsp->TOP__top.__PVT__dpc)),32);
    bufp->fullIData(oldp+646,((vlSymsp->TOP__top.Inst 
                               >> 7U)),25);
    ...
    __Vtemp_h75f56fbe__0[0xaU] = (0x2000U | ((IData)(
                                                     ((((- (QData)((IData)(
                                                      ...
                                                      >> 0x20U)) 
                                             >> 0x14U));
    bufp->fullWData(oldp+647,(__Vtemp_h75f56fbe__0),335);
    bufp->fullWData(oldp+658,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[0]),67);
    bufp->fullWData(oldp+661,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[1]),67);
    bufp->fullWData(oldp+664,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[2]),67);
    bufp->fullWData(oldp+667,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[3]),67);
    bufp->fullWData(oldp+670,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[4]),67);
    bufp->fullQData(oldp+673,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[0]),64);
    bufp->fullQData(oldp+675,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[1]),64);
    bufp->fullQData(oldp+677,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[2]),64);
    bufp->fullQData(oldp+679,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[3]),64);
    bufp->fullQData(oldp+681,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[4]),64);
    bufp->fullQData(oldp+683,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__lut_out),64);
    bufp->fullBit(oldp+685,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__hit));
