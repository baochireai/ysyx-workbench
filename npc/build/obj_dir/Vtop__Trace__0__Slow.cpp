...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+981,"lsu_valid", false,-1);
    tracep->declBit(c+981,"wb_ready", false,-1);
    tracep->declBit(c+723,"isclint", false,-1);
    tracep->declBit(c+724,"RdEn", false,-1);
    tracep->declBit(c+725,"Datamem_we", false,-1);
    tracep->declBit(c+726,"clint_we", false,-1);
    tracep->declBit(c+727,"clint_re", false,-1);
    tracep->declQuad(c+728,"dataMem_out", false,-1, 63,0);
    tracep->declQuad(c+730,"clint_dout", false,-1, 63,0);
    tracep->declBit(c+732,"clint_mtip_next", false,-1);
    tracep->pushNamePrefix("DataMem ");
    tracep->declBit(c+958,"clk", false,-1);
    tracep->declQuad(c+241,"Addr", false,-1, 63,0);
    tracep->declBus(c+297,"MemOP", false,-1, 2,0);
    tracep->declQuad(c+295,"DataIn", false,-1, 63,0);
    tracep->declBit(c+725,"WrEn", false,-1);
    tracep->declQuad(c+728,"DataOut", false,-1, 63,0);
    tracep->declBus(c+733,"wmask", false,-1, 7,0);
    tracep->declBit(c+734,"isSign", false,-1);
    tracep->declBit(c+735,"RdEn", false,-1);
    tracep->declBus(c+736,"shift", false,-1, 5,0);
    tracep->declArray(c+737,"data", false,-1, 127,0);
    tracep->declBus(c+741,"extmask", false,-1, 15,0);
    tracep->pushNamePrefix("deMemOP ");
    tracep->declBus(c+997,"NR_KEY", false,-1, 31,0);
    tracep->declBus(c+991,"KEY_LEN", false,-1, 31,0);
    tracep->declBus(c+1025,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+992,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declBus(c+733,"out", false,-1, 7,0);
    tracep->declBus(c+742,"key", false,-1, 1,0);
    ...
    tracep->declBus(c+743,"lut_out", false,-1, 7,0);
    tracep->declBit(c+744,"hit", false,-1);
    tracep->declBus(c+1003,"i", false,-1, 31,0);
    tracep->pushNamePrefix("genblk1 ");
    tracep->popNamePrefix(2);
    ...
    tracep->declBus(c+998,"DATA_LEN", false,-1, 31,0);
    tracep->declBus(c+992,"HAS_DEFAULT", false,-1, 31,0);
    tracep->declQuad(c+728,"out", false,-1, 63,0);
    tracep->declBus(c+742,"key", false,-1, 1,0);
    tracep->declQuad(c+1000,"default_out", false,-1, 63,0);
    tracep->declArray(c+745,"lut", false,-1, 263,0);
    tracep->declBus(c+1002,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 4; ++i) {
        tracep->declArray(c+754+i*3,"pair_list", true,(i+0), 65,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declBus(c+121+i*1,"key_list", true,(i+0), 1,0);
    }
    for (int i = 0; i < 4; ++i) {
        tracep->declQuad(c+766+i*2,"data_list", true,(i+0), 63,0);
    }
    tracep->declQuad(c+774,"lut_out", false,-1, 63,0);
    ...
    tracep->declBit(c+727,"re", false,-1);
    tracep->declBit(c+732,"clint_mtip", false,-1);
    tracep->declQuad(c+730,"clint_dout", false,-1, 63,0);
    tracep->declQuad(c+777,"mtime", false,-1, 63,0);
    tracep->declQuad(c+779,"mtimecmp", false,-1, 63,0);
    tracep->declBit(c+781,"ismtimecmp", false,-1);
    tracep->declBit(c+782,"ismtime", false,-1);
    ...
    tracep->declQuad(c+779,"dout", false,-1, 63,0);
    ...
    tracep->declBus(c+784,"waddr", false,-1, 31,0);
    tracep->declBus(c+1041,"raddr", false,-1, 31,0);
    tracep->declBus(c+785,"wstrb", false,-1, 7,0);
    tracep->declBit(c+786,"wdata_done", false,-1);
    tracep->declBit(c+1042,"raddr_done", false,-1);
...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__top__WB__IntrUnit__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+1043,"isCSRw", false,-1);
    ...
    tracep->declQuad(c+1000,"default_out", false,-1, 63,0);
    tracep->declArray(c+1044,"lut", false,-1, 131,0);
    tracep->declBus(c+1002,"PAIR_LEN", false,-1, 31,0);
    for (int i = 0; i < 2; ++i) {
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullIData(oldp+721,(((0U == (7U & (IData)(vlSymsp->TOP__top.__PVT__IFU__DOT__NextPC)))
                                ...
                                : (IData)((vlSymsp->TOP__top.__PVT__ram_rdata 
                                           >> 0x20U)))),32);
    bufp->fullBit(oldp+722,(((IData)(vlSymsp->TOP__top.__PVT__ifu_ready) 
                             & (IData)(vlSymsp->TOP__top.__PVT__ram_rvalid))));
    bufp->fullBit(oldp+723,(vlSymsp->TOP__top.__PVT__LSU__DOT__isclint));
    bufp->fullBit(oldp+724,(((~ (IData)(vlSymsp->TOP__top.__PVT__mem_MemWr)) 
                             & (0U != (IData)(vlSymsp->TOP__top.__PVT__mem_MemOP)))));
    bufp->fullBit(oldp+725,(vlSymsp->TOP__top.__PVT__LSU__DOT__Datamem_we));
    bufp->fullBit(oldp+726,(vlSymsp->TOP__top.__PVT__LSU__DOT__clint_we));
    bufp->fullBit(oldp+727,(((IData)(vlSymsp->TOP__top.__PVT__LSU__DOT__isclint) 
                             & ((~ (IData)(vlSymsp->TOP__top.__PVT__mem_MemWr)) 
                                & (0U != (IData)(vlSymsp->TOP__top.__PVT__mem_MemOP))))));
    bufp->fullQData(oldp+728,(vlSymsp->TOP__top.__PVT__LSU__DOT__dataMem_out),64);
    bufp->fullQData(oldp+730,(((- (QData)((IData)(((IData)(vlSymsp->TOP__top.__PVT__LSU__DOT__isclint) 
                                                   & ((~ (IData)(vlSymsp->TOP__top.__PVT__mem_MemWr)) 
                                                      & (0U 
                               ...
                               & ((0x200bff8ULL == vlSymsp->TOP__top.__PVT__ALUres)
                                   ...
                                   : ((0x2004000ULL 
                                       ...
                                       : 0ULL)))),64);
    bufp->fullBit(oldp+732,((vlSymsp->TOP__top.__PVT__LSU__DOT__clintU__DOT__mtime 
                             > vlSymsp->TOP__top.__PVT__LSU__DOT__clintU__DOT__mtimecmp)));
    bufp->fullCData(oldp+733,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__wmask),8);
    bufp->fullBit(oldp+734,((1U & ((IData)(vlSymsp->TOP__top.__PVT__mem_MemOP) 
                                   >> 2U))));
    bufp->fullBit(oldp+735,(((~ (IData)(vlSymsp->TOP__top.__PVT__LSU__DOT__Datamem_we)) 
                             & (0U != (IData)(vlSymsp->TOP__top.__PVT__mem_MemOP)))));
    bufp->fullCData(oldp+736,((0x38U & ((IData)(vlSymsp->TOP__top.__PVT__ALUres) 
                                        << 3U))),6);
    bufp->fullWData(oldp+737,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__data),128);
    bufp->fullSData(oldp+741,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__extmask),16);
    bufp->fullCData(oldp+742,((3U & (IData)(vlSymsp->TOP__top.__PVT__mem_MemOP))),2);
    bufp->fullCData(oldp+743,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__deMemOP__DOT__lut_out),8);
    bufp->fullBit(oldp+744,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__deMemOP__DOT__hit));
    ...
    __Vtemp_h76b581e7__0[8U] = ((IData)(((((QData)((IData)(
                                         ...
                                         >> 0x20U)) 
                                >> 0x1aU);
    bufp->fullWData(oldp+745,(__Vtemp_h76b581e7__0),264);
    bufp->fullWData(oldp+754,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__pair_list[0]),66);
    bufp->fullWData(oldp+757,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__pair_list[1]),66);
    bufp->fullWData(oldp+760,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__pair_list[2]),66);
    bufp->fullWData(oldp+763,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__pair_list[3]),66);
    bufp->fullQData(oldp+766,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__data_list[0]),64);
    bufp->fullQData(oldp+768,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__data_list[1]),64);
    bufp->fullQData(oldp+770,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__data_list[2]),64);
    bufp->fullQData(oldp+772,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__data_list[3]),64);
    bufp->fullQData(oldp+774,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__lut_out),64);
    bufp->fullBit(oldp+776,(vlSymsp->TOP__top.__PVT__LSU__DOT__DataMem__DOT__sext__DOT__hit));
    bufp->fullQData(oldp+777,(vlSymsp->TOP__top.__PVT__LSU__DOT__clintU__DOT__mtime),64);
    bufp->fullQData(oldp+779,(vlSymsp->TOP__top.__PVT__LSU__DOT__clintU__DOT__mtimecmp),64);
    bufp->fullBit(oldp+781,((0x2004000ULL == vlSymsp->TOP__top.__PVT__ALUres)));
    bufp->fullBit(oldp+782,((0x200bff8ULL == vlSymsp->TOP__top.__PVT__ALUres)));
    bufp->fullBit(oldp+783,(((IData)(vlSymsp->TOP__top.__PVT__LSU__DOT__clint_we) 
                             & (0x2004000ULL == vlSymsp->TOP__top.__PVT__ALUres))));
    bufp->fullIData(oldp+784,(vlSymsp->TOP__top.__PVT__ram_axi_lite_u__DOT__waddr),32);
    ...
    bufp->fullIData(oldp+1031,(vlSymsp->TOP__top.__PVT__IFU__DOT__inst),32);
    ...
    bufp->fullIData(oldp+1041,(vlSymsp->TOP__top.__PVT__ram_axi_lite_u__DOT__raddr),32);
    bufp->fullBit(oldp+1042,(vlSymsp->TOP__top.__PVT__ram_axi_lite_u__DOT__raddr_done));
    bufp->fullBit(oldp+1043,(vlSymsp->TOP__top__WB__IntrUnit.__PVT__isCSRw));
    ...
    bufp->fullWData(oldp+1044,(__Vtemp_h058c0b04__0),132);
    bufp->fullQData(oldp+1049,(0xa00001800ULL),64);
