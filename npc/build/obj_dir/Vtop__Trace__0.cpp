...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[2U])) {
        ...
        bufp->chgCData(oldp+232,(((IData)(vlSymsp->TOP__top.__VdfgTmp_ha793c56c__0)
        ...
        bufp->chgQData(oldp+241,((0xfffffffffffffffeULL 
        ...
        bufp->chgQData(oldp+262,(vlSymsp->TOP__top.__PVT__inst_o),64);
        bufp->chgQData(oldp+264,(vlSymsp->TOP__top.__PVT__ram_rdata),64);
        bufp->chgBit(oldp+266,(vlSymsp->TOP__top.__PVT__ram_rvalid));
        bufp->chgCData(oldp+267,(vlSymsp->TOP__top.__PVT__ram_rresp),2);
        bufp->chgBit(oldp+268,(vlSymsp->TOP__top.__PVT__AWREADY));
        bufp->chgBit(oldp+269,(vlSymsp->TOP__top.__PVT__WREADY));
        bufp->chgBit(oldp+270,(vlSymsp->TOP__top.__PVT__BVALID));
        bufp->chgCData(oldp+271,(vlSymsp->TOP__top.__PVT__BRESP),2);
        ...
        __Vtemp_hc8888693__0[7U] = (((IData)(VL_DIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB)) 
                                     >> 0x1aU) | ((IData)(
                                                          (VL_DIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                           >> 0x20U)) 
                                                  << 6U));
        __Vtemp_hc8888693__0[8U] = (0x80U | ((IData)(
                                                     (VL_DIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                      >> 0x20U)) 
                                             >> 0x1aU));
        bufp->chgWData(oldp+486,(__Vtemp_hc8888693__0),264);
        ...
        __Vtemp_h8f626b3d__0[7U] = (((IData)(VL_MODDIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB)) 
                                     >> 0x1aU) | ((IData)(
                                                          (VL_MODDIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                           >> 0x20U)) 
                                                  << 6U));
        __Vtemp_h8f626b3d__0[8U] = (0x80U | ((IData)(
                                                     (VL_MODDIV_QQQ(64, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUA, vlSymsp->TOP__top.__PVT__ALU__DOT__ALUB) 
                                                      >> 0x20U)) 
                                             >> 0x1aU));
        bufp->chgWData(oldp+518,(__Vtemp_h8f626b3d__0),264);
        ...
        bufp->chgIData(oldp+642,((IData)(vlSymsp->TOP__top.pc)),32);
        bufp->chgIData(oldp+643,((vlSymsp->TOP__top.Inst 
                                  >> 7U)),25);
        ...
        __Vtemp_h75f56fbe__0[0xaU] = (0x2000U | ((IData)(
                                                         ((((- (QData)((IData)(
                                                          ...
                                                          >> 0x20U)) 
                                                 >> 0x14U));
        bufp->chgWData(oldp+644,(__Vtemp_h75f56fbe__0),335);
        bufp->chgWData(oldp+655,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[0]),67);
        bufp->chgWData(oldp+658,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[1]),67);
        bufp->chgWData(oldp+661,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[2]),67);
        bufp->chgWData(oldp+664,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[3]),67);
        bufp->chgWData(oldp+667,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__pair_list[4]),67);
        bufp->chgQData(oldp+670,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[0]),64);
        bufp->chgQData(oldp+672,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[1]),64);
        bufp->chgQData(oldp+674,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[2]),64);
        bufp->chgQData(oldp+676,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[3]),64);
        bufp->chgQData(oldp+678,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__data_list[4]),64);
        bufp->chgQData(oldp+680,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__lut_out),64);
        bufp->chgBit(oldp+682,(vlSymsp->TOP__top.__PVT__ImmGen__DOT__isRegWr__DOT__hit));
        bufp->chgQData(oldp+683,(((((IData)(vlSymsp->TOP__top.__PVT__IntrEn) 
                                    & (IData)(vlSymsp->TOP__top__IntrUnit.__PVT__ismret)) 
                                   | (IData)(vlSymsp->TOP__top__IntrUnit.__PVT__irq_raise))
                                   ? ((IData)(vlSymsp->TOP__top__IntrUnit.__PVT__irq_raise)
                                       ? vlSymsp->TOP__top__IntrUnit.__PVT__mtvec
