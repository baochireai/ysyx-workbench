...
VL_MODULE(Vtop___024root) {
  public:
    ...
    struct {
        ...
        VlUnpacked<CData/*4:0*/, 5> top__DOT__GenNextPC__DOT__dePCsrc__DOT__pair_list;
        VlUnpacked<CData/*2:0*/, 5> top__DOT__GenNextPC__DOT__dePCsrc__DOT__key_list;
        VlUnpacked<CData/*1:0*/, 5> top__DOT__GenNextPC__DOT__dePCsrc__DOT__data_list;
        VlUnpacked<QData/*63:0*/, 32> top__DOT__RegisterFile__DOT__rf;
        VlUnpacked<SData/*9:0*/, 9> top__DOT__ContrGen__DOT__deExtop__DOT__pair_list;
        VlUnpacked<CData/*6:0*/, 9> top__DOT__ContrGen__DOT__deExtop__DOT__key_list;
        VlUnpacked<CData/*2:0*/, 9> top__DOT__ContrGen__DOT__deExtop__DOT__data_list;
    ...
    struct {
        ...
        VlUnpacked<SData/*10:0*/, 1> top__DOT__DataMem__DOT__deMemOP__DOT__pair_list;
        VlUnpacked<CData/*2:0*/, 1> top__DOT__DataMem__DOT__deMemOP__DOT__key_list;
        VlUnpacked<CData/*7:0*/, 1> top__DOT__DataMem__DOT__deMemOP__DOT__data_list;
        VlUnpacked<VlWide<3>/*64:0*/, 2> top__DOT__RegWsrcMux__DOT__pair_list;
        VlUnpacked<CData/*0:0*/, 2> top__DOT__RegWsrcMux__DOT__key_list;
        VlUnpacked<QData/*63:0*/, 2> top__DOT__RegWsrcMux__DOT__data_list;
    };
    ...
    IData/*24:0*/ top__DOT__GenNextPC__DOT____Vcellinp__dePCsrc__lut;
